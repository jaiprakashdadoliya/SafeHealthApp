...
export const NewReportModal = (props) => { 
  return (
    <div>
      <Modal show={props.newReportModalShow} onHide={props.handleClose} backdrop="static" keyboard={false}>
        ...
        <Modal.Footer>
          ...
          <Button className="btn text-btn green" onClick={props.reportSubmit.bind(null, 'add')}>Save</Button>
        </Modal.Footer>
      </Modal>
    </div>
  );
