...
export const NewTestModal = (props) => { 
  return (
    <div>
      <Modal show={props.newTestModalShow} onHide={props.handleClose} backdrop="static" keyboard={false}>
        ...
        <Modal.Footer>
          ...
          <Button className="btn text-btn green" onClick={props.testSubmit.bind(null, 'add')}>Save</Button>
        </Modal.Footer>
      </Modal>
    </div>
  );
