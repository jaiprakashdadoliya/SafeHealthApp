...
export const EditReportModal = (props) => {    
  return (
    <div>
      <Modal show={props.editReportModalShow} onHide={props.handleClose} backdrop="static" keyboard={false}>
        ...
        <Modal.Footer>
          ...
          <Button className="btn text-btn green" onClick={props.reportSubmit.bind(null, 'edit')}>Save</Button>
        </Modal.Footer>
      </Modal>
    </div>
  );
