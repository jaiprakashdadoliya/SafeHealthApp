...
*/
export const patientMedicalHistoryService = {
    getTablelist,
    doSubmitRequest,
    doDeleteRequest
};
...
function doSubmitRequest(patientDetails) { 
    return axios({
            method: 'post',
            url: configConstants.API_BASE_PATH+'visit/medication-history/save',
...
function getTablelist(patId, visitId, page, pageSize, sorted, filtered) {
    ...
    return axios({
            method  : 'post',
            url     : configConstants.API_BASE_PATH+'visit/medication-history/list',
            data    : dataForm,
...
function doDeleteRequest(patientDetails) {
    return axios({
        method  : 'delete',
        url     : configConstants.API_BASE_PATH + 'visit/medication-history/delete',
        headers : headerHelper.getHeaderWithAuthorization(),
