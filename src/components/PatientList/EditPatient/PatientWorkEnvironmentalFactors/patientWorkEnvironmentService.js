...
*/
export const patientWorkEnvironmentService = {
    getTablelist,
    doSubmitRequest,
    doDeleteRequest
};
...
function doSubmitRequest(patientDetails) { 
    return axios({
            method: 'post',
            url: configConstants.API_BASE_PATH+'visit/workenvironment/save',
...
function getTablelist(patId, visitId, page, pageSize, sorted, filtered) {
    ...
    return axios({
            method  : 'post',
            url     : configConstants.API_BASE_PATH+'visit/workenvironment/list',
            data    : dataForm,
...
* @return                JSON
*/
function doDeleteRequest(autoIncId) {
    var deleteData = {'wef_id':autoIncId};
    return axios({
        method  : 'delete',
        url     : configConstants.API_BASE_PATH + 'visit/workenvironment/delete',
        headers : headerHelper.getHeaderWithAuthorization(),
