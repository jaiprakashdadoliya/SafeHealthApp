...
export class PatientAddMedicine extends React.Component {
...
handleClose() {
  this.props.patientAddMedicineHideHandle();
}
render() {
        return (
          <div>
            <Modal show={this.props.patientAddMedicine} onHide={this.handleClose}>
