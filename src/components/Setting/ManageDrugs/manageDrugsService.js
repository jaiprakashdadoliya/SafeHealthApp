 ...
 * @ShortDescription       This is responsible for calling all api related to add drugs
 */
...
*/
export const manageDrugsService = {
    getTablelist,
    doSubmitRequest,
    doDeleteRequest,
    getOptionlist
...
function doSubmitRequest(details) { 
    return axios({
            method: 'post',
            url: configConstants.API_BASE_PATH+'setting/mangae-drug/save',
...
function getTablelist(page, pageSize, sorted, filtered) {
    ...
    return axios({
            method  : 'post',
            url     : configConstants.API_BASE_PATH+'setting/mangae-drug/list',
            data    : dataForm,
            headers : headerHelper.getHeaderWithAuthorization()
        }).then(function (response) {
            return response;
...
function doDeleteRequest(details) {
    return axios({
        method  : 'delete',
        url     : configConstants.API_BASE_PATH + 'setting/mangae-drug/delete',
        headers : headerHelper.getHeaderWithAuthorization(),
        data    : headerHelper.appendUserDataInJson(details)
    })
    .then(response => {
...
function getOptionlist() {
    return axios({
            method: 'get',
            url: configConstants.API_BASE_PATH+'setting/mangae-drug/optionlist',
            headers : headerHelper.getHeaderWithAuthorization()
        }).then(function (response) {
            return response;
        }).catch(function (response) {
