 ...
 *
 * @package                SafeHealth
 * @subpackage             DoctorEditTiming
 * @category               Presentational Component
 * @DateOfCreation         20 June 2018
 * @ShortDescription       This component is reponsible to show the Doctor timing Edit modal
 */
export const DoctorEditTiming = (props) => {

    return(
        <div>
            <Modal show={props.timingEditModelShow} onHide={props.handleClose}>
                    ...
                    <div className="row">
                        <div className="col-md-4">
                            <div className='form-group'>
                                {utilityHelper.getWeekdayName(props.payload.timing.week_day)}
