...
import {Button, Modal, Alert, bsStyle, Pill} from 'react-bootstrap';
 ...
 *
 * @package                SafeHealth
 * @subpackage             DoctorSpecialisationAdd
 * @category               Presentational Component
 * @DateOfCreation         31 May 2018
 * @ShortDescription       This component is reponsible to show the Doctor Specialisation add modal
 */
export const DoctorSpecialisationAdd = (props) => {
return (
  <div>
    <Modal show={props.specialisationAddShow} onHide={props.handleClose}>
