    ...
    value: function saveSession(session) {
      return new Promise(function (resolve) {
        if (instance.server) {
          ...
          Cookies.set(_constants.USER_SESSION, session, { expires: instance.expires, secure: _constants.SECURE_PROTOCOL });
          instance.store.dispatch((0, _actions.getSessionSuccess)());
          resolve();
        } else {
    ...
    value: function saveUser(user) {
      return new Promise(function (resolve) {
        if (instance.server) {
          ...
          Cookies.set(_constants.USER_DATA, user, { expires: instance.expires, secure: _constants.SECURE_PROTOCOL });
          instance.store.dispatch((0, _actions.getUserSessionSuccess)(user));
          resolve();
        } else {
